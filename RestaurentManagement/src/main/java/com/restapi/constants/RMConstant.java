...
<<<<<<< HEAD
    ...
    public static final String TYPE_OK_FOR_ID = "Get type successfully";
    public static final String TYPE_OK_FOR_CREATE = "Create type successfully";
    public static final String TYPE_OK_FOR_UPDATE = "Update type successfully";
    public static final String TYPE_OK_FOR_DELETE = "Delete type successfully";
    public static final String MENU_OK_FOR_ID = "Get menu successfully";
